package modules.gamePlatform.view
{
    ...
    public class GameTableDaxiaoViewMediator extends GameTableViewMediator 
    {
        ...
        private function get view():GameTableDaxiaoView
        {
            return ((viewComponent as GameTableDaxiaoView));
        }
        ...
        {
            this.gameModel.showResultPanel("daxiao");
        }
