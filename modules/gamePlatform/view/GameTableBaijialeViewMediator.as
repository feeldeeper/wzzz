package modules.gamePlatform.view
{
    ...
    public class GameTableBaijialeViewMediator extends GameTableViewMediator 
    {
        ...
        private function get view():GameTableBaijialeView
        {
            return ((viewComponent as GameTableBaijialeView));
        }
        ...
        private function waitGotoGame(_arg1:GamePlatformModelEvent):void
        {
            ...
            {
                _local2 = this.gameModel.waitGameModel.getMoneyGroup(this.view.tableVO.gameType);
