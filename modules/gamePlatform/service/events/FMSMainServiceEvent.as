package modules.gamePlatform.service.events
{
    ...
    public class FMSMainServiceEvent extends Event 
    {
        ...
        public function FMSMainServiceEvent(_arg1:String, _arg2:Boolean=false, _arg3:Boolean=false)
        {			
        ...
        {
            var _local1:FMSMainServiceEvent = new FMSMainServiceEvent(type, bubbles, cancelable);
